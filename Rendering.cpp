...
void LTexture::render(SDL_Renderer* gRenderer, int x, int y,float scaler, SDL_Rect* clip , double angle, SDL_Point* center, SDL_RendererFlip flip )
{
...
// MUST MODIFY
void LBGTile::render(SDL_Renderer* gRenderer, float scaler, SDL_Rect* clip ,SDL_Rect* InputScreen , double angle , SDL_Point* center , SDL_RendererFlip flip )
{
	//Set rendering space and render to screen
    SDL_Rect renderQuad;
